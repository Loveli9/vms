 ...
 *
 */
public class ProjectLabelMeasure {
	...
	private List<ShowMeasureCat> measureCatList;//该流程下的所有指标类目及指标
	...
	public List<ShowMeasureCat> getMeasureCatList() {
		return measureCatList;
	}
	public void setMeasureCatList(List<ShowMeasureCat> measureCatList) {
