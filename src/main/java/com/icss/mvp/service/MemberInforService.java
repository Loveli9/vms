...
public class MemberInforService {
	...
	public String projectPostRank(String post) {
		String rank = " ";
		switch(post) {
		   case "PM":rank = "6级";break;
		   case "SE":rank = "5级";break;
		   case "开发工程师":rank = "5级";break;
		}
		return rank;
	}
	...
	public void saveProjectInformation(ProjectMembersInformation project) {
			...
			Integer achievement =  achievements.get(0); i = achievements.get(1);
			achievements = achievementsValue(project.getAchievementsThree(),i);
			achievement +=  achievements.get(0); i = achievements.get(1);
