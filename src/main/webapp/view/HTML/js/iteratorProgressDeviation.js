$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/iteratorList/iteratorProgressDeviation',
			type: 'post',
			...
			success: function (data) {
				$("#iteratorProgressDeviation thead tr").not(':eq(0)').remove();
				$("#iteratorProgressDeviation tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#iteratorProgressDeviation thead").append(target);
				$("#iteratorProgressDeviation tbody").append(tab);
			}
		});
	}
