$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/iteratorList/iteratorWorkloadDeviation',
			type: 'post',
			...
			success: function (data) {
				$("#iteratorWorkloadDeviation thead tr").not(':eq(0)').remove();
				$("#iteratorWorkloadDeviation tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#iteratorWorkloadDeviation thead").append(target);
				$("#iteratorWorkloadDeviation tbody").append(tab);
			}
		});
	}
