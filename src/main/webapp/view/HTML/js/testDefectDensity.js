$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/testList/getTestDefectDensity',
			type: 'post',
			...
			success: function (data) {
				$("#testDefectDensity thead tr").not(':eq(0)').remove();
				$("#testDefectDensity tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#testDefectDensity thead").append(target);
				$("#testDefectDensity tbody").append(tab);
			}
		});
	}
