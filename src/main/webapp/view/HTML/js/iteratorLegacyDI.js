$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/iteratorList/iteratorLegacyDI',
			type: 'post',
			...
			success: function (data) {
				$("#iteratorLegacyDI thead tr").not(':eq(0)').remove();
				$("#iteratorLegacyDI tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#iteratorLegacyDI thead").append(target);
				$("#iteratorLegacyDI tbody").append(tab);
			}
		});
	}
