$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/testList/getTestMissing',
			type: 'post',
			...
			success: function (data) {
				$("#testMissing thead tr").not(':eq(0)').remove();
				$("#testMissing tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#testMissing thead").append(target);
				$("#testMissing tbody").append(tab);
			}
		});
	}
