$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/testList/getTestcaseDefectRate',
			type: 'post',
			...
			success: function (data) {
				$("#testcaseDefectRate thead tr").not(':eq(0)').remove();
				$("#testcaseDefectRate tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#testcaseDefectRate thead").append(target);
				$("#testcaseDefectRate tbody").append(tab);
			}
		});
	}
