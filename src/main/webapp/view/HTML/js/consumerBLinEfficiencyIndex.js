...
$(function(){
    ...
    function initPDUTable(){
        ...
        var url = getRootPath() + '/projectReport/getCousumerEfficiencyPDUIndex';
    ...
    function initProjectTable(){
        ...
        var url = getRootPath() + '/projectReport/getCousumerQualityProjectIndex';
    ...
    function initPDUColumn(){
        return [
            ...
            {title:'代码开发效率',field:'id528',width:110,
        		formatter:function(value,row,index){
            ...
            {title:'E2E代码开发效率',field:'id575',width:130,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'问题解决效率',field:'id523',width:110,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'版本交付效率',field:'id541',width:100,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'版本需求开发效率',field:'id579',width:120,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'手工测试执行效率',field:'id574',width:110,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'测试用例设计效率',field:'id564',width:110,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
            ...
            {title:'测试自动化脚本开发效率',field:'id572',width:110,
            	formatter:function(value,row,index){
            		 var vals = value== null? '0' :(''+ value);
                 	 deng = getDeng2(vals);
                     resultTatil = '<div style="width: 100%;text-align: left;">'+
    ...
    function initProjectColumn(){
        return [
            ...
            {title:'代码开发效率',field:'id576',width:110,
                formatter:function(value,row,index){
                	if(value =="--"){
                		var val = 0 ;
                		var vals = value ;
