...
//            {title:'阶段',field:'',width:80},
    ...
    $(document).ready(function(){
    	...
    	if (Menus.indexOf("-101-") != -1) {
    		var tab2 ='<li tabname="tab-ziyuan" id="ziYuan" onclick="loadResourceReport()" style="border: 0px;margin-left: 15px;"><a href="###">资源</a></li>';
    		$("#quality").append(tab2);
    		if(!flag){
    			$("#ziYuan").click();
    			flag = true;
    	...
    	if (Menus.indexOf("-102-") != -1) {
    		var tab3 ='<li tabname="tab-jindu" id="jinDu" onclick="" style="border: 0px;margin-left: 15px;"><a href="###">进度</a></li>';
    		$("#quality").append(tab3);
    		if(!flag){
    			$("#jinDu").click();
    			flag = true;
    	...
    	if (Menus.indexOf("-103-") != -1) {
    		var tab4 ='<li tabname="tab-biangeng" id="bianGeng" onclick="" style="border: 0px;margin-left: 15px;"><a href="###">变更</a></li>';
    		$("#quality").append(tab4);
    		if(!flag){
    			$("#bianGeng").click();
    			flag = true;
