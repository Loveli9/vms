...
$(function () {
    ...
    $('#branch').bootstrapTable({
        ...
        columns: [
            ...
            //        var pageSize = $('#dict').bootstrapTable('getOptions').pageSize;
            //        var pageNumber = $('#dict').bootstrapTable('getOptions').pageNumber;
        ...
        if ($("#entryDetailForm").data('bootstrapValidator').isValid()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //} else if (data.code == 'rep') {
                    //    toastr.warning('编号不能重复，请勿重复保存！');
                }
            });
        }
    });
