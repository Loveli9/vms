$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/iteratorList/iteratorTestReport',
			type: 'post',
			...
			success: function (data) {
				$("#iteratorTestReport thead tr").not(':eq(0)').remove();
				$("#iteratorTestReport tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#iteratorTestReport thead").append(target);
				$("#iteratorTestReport tbody").append(tab);
			}
		});
	}
