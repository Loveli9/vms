$(function(){
	...
	$.fn.loadIndex=function(){
		$.ajax({
			url: getRootPath() + '/iteratorList/iteratorProblemSolving',
			type: 'post',
			...
			success: function (data) {
				$("#iteratorProblemSolving thead tr").not(':eq(0)').remove();
				$("#iteratorProblemSolving tbody tr").remove();
				var tab = "";
				var deng = "";
				...
				$("#iteratorProblemSolving thead").append(target);
				$("#iteratorProblemSolving tbody").append(tab);
			}
		});
	}
